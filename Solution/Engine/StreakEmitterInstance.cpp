...
//	}
//
//	myEmitter.myEffect->SetAlphaDelta(myEmitter.myStreakData.myAlphaDelta);
//	myEmitter.myEffect->SetSizeDelta(myEmitter.myStreakData.mySizeDelta);
//	myEmitter.myEffect->SetStartAlpha(myEmitter.myStreakData.myStartAlpha);
//
//	Engine::GetInstance()->GetContext()->IASetInputLayout(myEmitter.myStreakInputLayout);
//	Engine::GetInstance()->GetContext()->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_LINESTRIP);
//	Engine::GetInstance()->GetContext()->IASetVertexBuffers(myVertexBufferWrapper.myStartSlot
...
//	Engine::GetInstance()->GetContext()->IASetIndexBuffer(myIndexBufferWrapper.myIndexBuffer
...
//	{
//		myEmitter.myEffect->UpdateParticleTexture(myEmitter.myTexture);
//		hr = myEmitter.myEffect->GetTechnique()->GetPassByIndex(i)->Apply(0, Engine::GetInstance()->GetContext());
//		DL_ASSERT_EXP(SUCCEEDED(hr) == true, "Failed to get pass by index.");
//		Engine::GetInstance()->GetContext()->Draw(myStreaks.Size(), 0);
//	}
//
//	float floatArray[4];
//	floatArray[0] = 0;
...
//	floatArray[2] = 0;
//	floatArray[3] = 0;
//	Engine::GetInstance()->GetContext()->OMSetBlendState(myBlendStateNoBlend, floatArray, 0xFFFFFFFF);
//}
//
...
//
//		HRESULT hr = Engine::GetInstance()->GetContext()->Map(myVertexBufferWrapper.myVertexBuffer, 0, D3D11_MAP_WRITE_DISCARD, 0, &mappedResource);
...
//		}
//		Engine::GetInstance()->GetContext()->Unmap(myVertexBufferWrapper.myVertexBuffer, 0);
//	}
//}
