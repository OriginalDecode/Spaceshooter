...
struct EntityData
{
	...
	std::string myParticleEmitterXMLPath;
	std::string myStreakEmitterXMLPath;
...
private:
	...
	void LoadStreakEmitterComponent(EntityData& aEntityToAddTo, XMLReader& aDocument, tinyxml2::XMLElement* aStreakEmitterComponent);
